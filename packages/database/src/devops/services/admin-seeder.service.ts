...
export class AdminSeederService {
  ...
  /**
   * Semillas de permisos específicos de admin (con transformación para permissionType)
   */
  ...
  /**
   * Semillas de roles específicos de admin (con transformación para permissions)
   */
